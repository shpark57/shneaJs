...
`<script src="https://cdn.jsdelivr.net/gh/shpark57/shneaJs@latest/shnea.js"></script>` 로 js 호출 <br/>
`<script src="https://cdn.jsdelivr.net/gh/shpark57/shneaJs@latest/shneaJq.js"></script>` 로 jquery 포함된 함수 호출<br/>
